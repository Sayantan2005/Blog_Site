...
function CommentBox({ selectedBlog }) {
    ...
    const commentHandler = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                `https://blog-site-2-pzsc.onrender.com/api/v1/comment/${selectedBlog._id}/create`,
    ...
    useEffect(() => {
        const getAllcommentsofBlog = async () => {
            try {
                const res = await axios.get(`https://blog-site-2-pzsc.onrender.com/api/v1/comment/${selectedBlog._id}/comment/all`)
    ...
    const deleteComment = async (commentId) => {
        try {
            const res = await axios.delete(`https://blog-site-2-pzsc.onrender.com/api/v1/comment/${commentId}/delete`,{
 ...
 const editCommentHandler = async (commentId) => {
    try {
        ...
        const res = await axios.put(
            `https://blog-site-2-pzsc.onrender.com/api/v1/comment/${commentId}/edit`,
...
const likeCommentHandler = async (commentId) => {
    try {
        ...
        const res = await axios.get(
            `https://blog-site-2-pzsc.onrender.com/api/v1/comment/${commentId}/like`,
            { withCredentials: true }
        );
